<!-- COMPONENTE BOILERPLATE -->
  ...
  <div class="flex flex-col h-screen w-screen items-center justify-center bg-gray-200 align-middle">
  <h2 class="mb-6">Login</h2>
    <form @submit.prevent="signIn" class="max-w-500 rounded-lg bg-white p-10 shadow-xl flex flex-col gap-6">
      <div>
